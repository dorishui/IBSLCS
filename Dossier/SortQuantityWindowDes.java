...
class SortQuantityWindowDes extends JFrame implements ActionListener{
	JTable table;
	...
	public SortQuantityWindowDes(String title){
		super(title);

		productsD = AccessInventory.getItemArrayQuantityDes();
