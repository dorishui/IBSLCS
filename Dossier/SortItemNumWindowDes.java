...
class SortItemNumWindowDes extends JFrame implements ActionListener{
	JTable table;
	...
	public SortItemNumWindowDes(String title){
		super(title);

		productsD = AccessInventory.getItemArrayItemNumDes();
