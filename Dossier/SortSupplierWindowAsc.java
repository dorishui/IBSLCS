...
class SortSupplierWindowAsc extends JFrame implements ActionListener{
	JTable table;
	...
	public SortSupplierWindowAsc(String title){
		super(title);

		productsD = AccessInventory.getItemArraySupplierAsc();
