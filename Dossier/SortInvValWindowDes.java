...
class SortInvValWindowDes extends JFrame implements ActionListener{
	JTable table;
	...
	public SortInvValWindowDes(String title){
		super(title);

		productsD = AccessInventory.getItemArrayInvValDes();
