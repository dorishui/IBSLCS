...
class SortInvValWindowAsc extends JFrame implements ActionListener{
	JTable table;
	...
	public SortInvValWindowAsc(String title){
		super(title);

		productsD = AccessInventory.getItemArrayInvValAsc();
