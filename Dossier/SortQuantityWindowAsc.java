...
class SortQuantityWindowAsc extends JFrame implements ActionListener{
	JTable table;
	...
	public SortQuantityWindowAsc(String title){
		super(title);

		productsD = AccessInventory.getItemArrayQuantityAsc();
