...
class SortCategoryWindowDes extends JFrame implements ActionListener{
	JTable table;
    ...
    static ArrayList<Items> productsD = new ArrayList(); //D stands for display

	public SortCategoryWindowDes(String title){
		super(title);

		productsD = AccessInventory.getItemArrayCategoryDes();
