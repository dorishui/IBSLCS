...
class SortCategoryWindowAsc extends JFrame implements ActionListener{
	JTable table;
	...
	public SortCategoryWindowAsc(String title){
		super(title);

		productsD = AccessInventory.getItemArrayCategoryAsc();
